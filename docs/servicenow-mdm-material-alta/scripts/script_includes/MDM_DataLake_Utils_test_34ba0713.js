// Script Include: MDM_DataLake_Utils_test
// sys_id: 34ba0713934366109f8b369d1dba1022 | activo: true | updated: 04-08-2025 11:40:46
// description: MDM
...
var MDM_DataLake_Utils_test = Class.create();
MDM_DataLake_Utils_test.prototype = {
    initialize: function() {},
    extraerDatosBlobs: function() {

        try {
            var r = new sn_ws.RESTMessageV2('DataLake', 'getListado');
